...
Каждый объект должен содержать поля:
	•	product — [строка] название товара и бренд (например, “молоко”, “батон”, “молоко 3.2%”, "туалетная бумага zewa", "молоко простоквашино 3.2%")
	•	quantity — [число] количество или объём (например, “1 л” - это "1", “2 штуки” - это "2", “1 упаковка” - это "1", “500 г” - это "0.5", “3 пачки” - это "3", “по 2 литра” - это "2")
	•	priceCategory — [строка] желаемая ценовая категория. Возможные значения:
    →	"cheapest" - самый дешевый
    →	"popular" - популярный
    →	"mostExpensive" - самый дорогой

⚠️ Поле quantity не может быть пустым. Всегда ставь 1 штуку, если не указано иное.
...
Верни только JSON-массив, без пояснений или форматирования текста.
